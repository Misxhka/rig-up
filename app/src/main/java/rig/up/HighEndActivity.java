...
import rig.up.ViewHolder.HEndViewHolder;

public class HighEndActivity extends AppCompatActivity implements FirebaseLoadDone {
    ...
    FirebaseRecyclerAdapter<Component, HEndViewHolder> adapter;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_high_end);

        searchableSpinnerMobo = findViewById(R.id.search_mobo_spinner_hi);
        searchableSpinnerCpu = findViewById(R.id.search_cpu_spinner_hi);
        searchableSpinnerRam = findViewById(R.id.search_ram_spinner_hi);
        searchableSpinnerGpu = findViewById(R.id.search_gpu_spinner_hi);
        searchableSpinnerStor = findViewById(R.id.search_storage_spinner_hi);
        searchableSpinnerCase = findViewById(R.id.search_casing_spinner_hi);
        searchableSpinnerPsu = findViewById(R.id.search_psu_spinner_hi);
    ...
    public void setSearchableSpinnerMobo(){
        component.orderByChild("Build_CategoryId").equalTo("017").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
    ...
    public void setSearchableSpinnerCpu(){
        component.orderByChild("Build_CategoryId").equalTo("018").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                List<Component> categories = new ArrayList<>();
    ...
    public void setSearchableSpinnerRam(){
        ...
        component.orderByChild("Build_CategoryId").equalTo("019").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                List<Component> categories = new ArrayList<>();
    ...
    public void setSearchableSpinnerGpu(){
        ...
        component.orderByChild("Build_CategoryId").equalTo("020").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                List<Component> categories = new ArrayList<>();
