...
import rig.up.ViewHolder.LEndViewHolder;

public class LowEndActivity extends AppCompatActivity implements FirebaseLoadDone {
    ...
    FirebaseRecyclerAdapter<Component, LEndViewHolder> adapter;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_low_end);

        searchableSpinnerMobo = findViewById(R.id.search_mobo_spinner_low);
        searchableSpinnerCpu = findViewById(R.id.search_cpu_spinner_low);
        searchableSpinnerRam = findViewById(R.id.search_ram_spinner_low);
        searchableSpinnerGpu = findViewById(R.id.search_gpu_spinner_low);
        searchableSpinnerStor = findViewById(R.id.search_storage_spinner_low);
        searchableSpinnerCase = findViewById(R.id.search_casing_spinner_low);
        searchableSpinnerPsu = findViewById(R.id.search_psu_spinner_low);
    ...
    private void showAlertDialog(){
        ...
        final Map<List<Component>, User> users = new HashMap<>();
    ...
    public void setSearchableSpinnerMobo(){
        component.orderByChild("Build_CategoryId").equalTo("01").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
    ...
    public void setSearchableSpinnerCpu(){
        component.orderByChild("Build_CategoryId").equalTo("02").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                List<Component> categories = new ArrayList<>();
    ...
    public void setSearchableSpinnerRam(){
        ...
        component.orderByChild("Build_CategoryId").equalTo("03").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                List<Component> categories = new ArrayList<>();
    ...
    public void setSearchableSpinnerGpu(){
        ...
        component.orderByChild("Build_CategoryId").equalTo("04").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                List<Component> categories = new ArrayList<>();
